...
- **Kịch bản**: Chạy script `test_stateless.py` để gửi 10 requests liên tiếp đến hệ thống đang scale (3 replicas).
- **Kết quả quan sát**:
  ```text
  Stateless Scaling Demo
  ============================================================
  Session ID: session_9d2f...
  ...
  Request 2: [agent-1]
    ...
    A: Containers provide a consistent environment...

  Request 3: [agent-3]
    Q: What is Kubernetes?
    A: Kubernetes is an open-source system for automating deployment...
  ...
  ```
- **Kết luận**: Hệ thống hoàn toàn stateless. Dữ liệu session không nằm ở RAM của Agent mà nằm ở Redis, cho phép bất kỳ instance nào cũng có thể xử lý request mà không làm mất ngữ cảnh trò chuyện.
